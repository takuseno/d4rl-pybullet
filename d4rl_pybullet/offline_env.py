"""
Currently, it is impossible to avoid activation key checks when importing d4rl.
Thus, offline_env.py is directly directly copied from https://github.com/rail-berkeley/d4rl/blob/1899859e3ebdac8f587abbe9cb1663761be69141/d4rl/offline_env.py
"""
